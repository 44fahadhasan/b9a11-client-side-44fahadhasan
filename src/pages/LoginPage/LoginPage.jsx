...
const LoginPage = () => {
  ...
  // auth
  const { userLogin, loginWithGithub, loginWithGoogle } = useAuth();
          ...
          <div className="text-base-content font-medium  w-full overflow-hidden ">
            <div className="md:flex">
              <div className="md:w-1/2 bg-base-100 py-10 rounded-md md:sticky md:top-5">
                {/* img */}
                <img
                  src="https://i.ibb.co/FYPSFD3/login.jpg"
                  alt="img"
              ...
              <div className="w-full md:w-1/2 py-10 px-5 md:px-10">
                ...
                <div>
                  ...
                  <div className="my-5 mb-6 text-right">
                    <a className="link link-hover hover:text-[#FF1949] underline">
                      Forgot Password?
                    </a>
                  </div>
