...
const FreeAskQue = () => {
  return (
    <div className="py-4 bg-base-100">
      <div className="px-4 sm:px-6 lg:px-8 flex flex-col justify-between container w-[87%] mx-auto poppins py-[70px]">
          ...
          <ul>
            <li className="text-left mb-10">
              <div className="flex flex-row items-start mb-5">
                <div className="flex items-center justify-center p-2 md:p-3 mr-2 md:mr-3 rounded-full bg-primary text-white border-2 md:border-4 border-white text-xl font-semibold">
                  <svg
                    width="30px"
                    fill="white"
                    height="30px"
                ...
                <div className="bg-base-200 p-5 px-10 w-full flex items-center rounded-sm">
                  <h4 className="text-md leading-6 font-medium text-base-content">
                    How do I submit an assignment on the website?
                  </h4>
                </div>
              </div>
              <div className="flex flex-row items-start">
                <div className="bg-base-300 p-5 px-10 w-full flex items-center rounded-md">
                  <p className="text-base-content text-sm">
                    To submit an assignment, log in to your account, navigate to
                    the assignment submission page, and follow the instructions
                    to upload your file or enter your submission directly into
                    the provided text box.
                  </p>
                </div>
                <div className="flex items-center justify-center p-2 md:p-3 ml-2 md:ml-3 rounded-full bg-primary text-white border-2 md:border-4 border-white text-xl font-semibold">
                  <svg
                    height="25px"
                    fill="white"
                    version="1.1"
            ...
            <li className="text-left mb-10">
              <div className="flex flex-row items-start mb-5">
                ...
                <div className="bg-base-200 p-5 px-10 w-full flex items-center rounded-sm">
                  <h4 className="text-md leading-6 font-medium text-base-content">
                    Is there a specific file format required for assignment
                    submissions?
                  </h4>
                </div>
              </div>
              <div className="flex flex-row items-start">
                <div className="bg-base-300 p-5 px-10 w-full flex items-center rounded-md">
                  <p className="text-base-content text-sm">
                    Typically, assignments can be submitted in various file
                    formats such as .doc, .docx, .pdf, or as specified by your
                    instructor. Always check the assignment instructions for any
                    format requirements.
                  </p>
                </div>
                <div className="flex items-center justify-center p-2 md:p-3 ml-2 md:ml-3 rounded-full bg-primary text-white border-2 md:border-4 border-white text-xl font-semibold">
            ...
            <li className="text-left mb-10">
              <div className="flex flex-row items-start mb-5">
                ...
                <div className="bg-base-200 p-5 px-10 w-full flex items-center rounded-sm">
                  <h4 className="text-md leading-6 font-medium text-base-content">
                    How can I check the status of my assignment after
                    submission?
                  </h4>
                </div>
              </div>
              <div className="flex flex-row items-start">
                <div className="bg-base-300 p-5 px-10 w-full flex items-center rounded-md">
                  <p className="text-base-content text-sm">
                    You can usually track the status of your assignment
                    submission on the website. Look for options like &quot;My
                    Assignments&quot; or &quot;Submission Status&quot; where you
                    can see if your assignment has been received and graded.
                  </p>
                </div>
                <div className="flex items-center justify-center p-2 md:p-3 ml-2 md:ml-3 rounded-full bg-primary text-white border-2 md:border-4 border-white text-xl font-semibold">
                  <svg
            ...
            <li className="text-left mb-10">
              <div className="flex flex-row items-start mb-5">
                ...
                <div className="bg-base-200 p-5 px-10 w-full flex items-center rounded-sm">
                  <h4 className="text-md leading-6 font-medium text-base-content">
                    How do I ensure the security of my personal information and
              ...
              <div className="flex flex-row items-start">
                <div className="bg-base-300 p-5 px-10 w-full flex items-center rounded-md">
                  <p className="text-base-content text-sm">
                    Online assignment websites typically have security measures
                    in place to protect your personal information and
                    assignments. Ensure you use strong, unique passwords and
                    follow any additional security guidelines provided by the
                    website.
                  </p>
                </div>
                <div className="flex items-center justify-center p-2 md:p-3 ml-2 md:ml-3 rounded-full bg-primary text-white border-2 md:border-4 border-white text-xl font-semibold">
